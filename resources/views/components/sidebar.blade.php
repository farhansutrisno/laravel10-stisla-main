    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('product') ? 'active' : '' }}">
                <a class="nav-link"
                    href="{{ url('product') }}"><i class="far fa-square"></i> <span>Master Produk</span></a>
            </li>

            <li class="{{ Request::is('posts') ? 'active' : '' }}">
                <a class="nav-link"
                    href="{{ url('posts') }}"><i class="far fa-square"></i> <span>Master Upload Specimen</span></a>
            </li>
            ...
            <li class="nav-item dropdown {{ isset($type_menu) && $type_menu === 'bootstrap' ? 'active' : '' }}">
                <a href="#"
            ...
            <li class="nav-item dropdown {{ isset($type_menu) && $type_menu === 'forms' ? 'active' : '' }}">
                <a href="#"
            ...
            <li class="nav-item dropdown {{ isset($type_menu) && $type_menu === 'modules' ? 'active' : '' }}">
                <a href="#"
            ...
            <li class="nav-item dropdown {{ isset($type_menu) && $type_menu === 'auth' ? 'active' : '' }}">
                <a href="#"
            ...
            <li class="nav-item dropdown {{ isset($type_menu) && $type_menu === 'error' ? 'active' : '' }}">
                <a href="#"
            ...
            <li class="nav-item dropdown {{ isset($type_menu) && $type_menu === 'features' ? 'active' : '' }}">
                <a href="#"
            ...
            <li class="nav-item dropdown {{ isset($type_menu) && $type_menu === 'utilities' ? 'active' : '' }}">
                <a href="#"
